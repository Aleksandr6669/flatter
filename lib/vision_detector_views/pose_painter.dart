  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final pose in poses) {
      pose.landmarks.forEach((_, landmark) {
        canvas.drawCircle(
            translate(landmark.x, landmark.y, size, absoluteImageSize, rotation,
                cameraLensDirection),
            1,
            paint);
      });
      ...
      void paintLine(PoseLandmarkType type1, PoseLandmarkType type2, Paint paintType) {
        ...
        canvas.drawLine(
            translate(joint1.x, joint1.y, size, absoluteImageSize, rotation,
                cameraLensDirection),
            translate(joint2.x, joint2.y, size, absoluteImageSize, rotation,
                cameraLensDirection),
            paintType);
      }
